...
import styles from './PorductCollection.module.css';
import { Row, Col, Typography, Divider } from 'antd';
import { ProductImage } from './ProductImage';

interface PropsType {
    title: JSX.Element; // JSX.Element 代表接受的是一个组件
    sideImage: string;
    products: any
}

export const PorductCollection: React.FC<PropsType> = ({ title, sideImage, products }) => {
    return (
